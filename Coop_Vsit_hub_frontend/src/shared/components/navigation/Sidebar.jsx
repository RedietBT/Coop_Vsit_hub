...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: CalendarDays,
    roles: ['ROLE_ADMIN', 'ROLE_DIRECTOR', 'ROLE_SECRETARY', 'ROLE_RELATIONSHIP_MANAGER', 'ROLE_APPROVER'],
  },
  {
  ...
  },
  {
    ...
    path: '/organizations',
    icon: Building2,
    roles: ['ROLE_ADMIN', 'ROLE_DIRECTOR', 'ROLE_SECRETARY', 'ROLE_RELATIONSHIP_MANAGER'],
  },
  {
