      ...
      <header className="sticky top-0 z-20 h-16 bg-white/95 backdrop-blur-md border-b border-slate-200 px-6 flex items-center justify-between transition-all select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {/* User Dropdown */}
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-60 bg-white rounded-2xl shadow-xl border border-slate-200 py-2 z-50 animate-fadeIn text-left">
                ...
                <div className="p-1 space-y-0.5">
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 rounded-xl transition-colors cursor-pointer"
                  >
