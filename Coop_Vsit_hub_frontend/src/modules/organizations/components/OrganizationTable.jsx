        ...
        <table className="w-full text-left text-xs">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50/70 text-slate-400 font-bold uppercase text-[10px]">
              ...
              <th className="py-3.5 px-4">Executive Contact</th>
            ...
            {isLoading ? (
              ...
              <tr>
                <td colSpan={6} className="py-24 text-center">
                  ...
                  <p className="text-xs text-slate-500 mt-1">Try searching by partner name or category.</p>
                </td>
              </tr>
            ) : (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="truncate max-w-[200px]">
                          ...
                          <p className="text-[10px] text-slate-400 font-normal truncate mt-0.5">
                            {org.marketCountry || 'Ethiopia'} • {org.category || 'Strategic Partner'}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-4 px-4 font-semibold text-slate-800">
                      <span className="px-2.5 py-1 rounded-xl bg-slate-100 text-slate-800 font-bold text-[10px]">
                        {org.industrySector || 'Enterprise & Telecom'}
                      </span>
                    </td>

                    {/* Contact Person */}
                    <td className="py-4 px-4 text-slate-600">
                      <p className="font-bold text-[#000000] truncate max-w-[170px]">
                        {org.primaryContactPerson || 'Executive Liaison'}
                      </p>
                      <div className="flex items-center gap-1 text-[10px] text-slate-400 truncate max-w-[170px] mt-0.5">
                        <Mail className="w-3 h-3 text-slate-400 shrink-0" />
                        <span className="truncate">{org.contactEmail || 'contact@partner.et'}</span>
                      </div>
                    </td>
