                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-1.5">
                        <div className="flex items-center">
                          {[1, 2, 3, 4, 5].map((star) => {
                            const starVal = org.starRating || (org.relationshipScore ? Math.round((org.relationshipScore / 20) * 10) / 10 : 4.8);
                        ...
                        <span className="font-mono font-bold text-slate-800 text-xs">
                          {(org.starRating || (org.relationshipScore ? Math.round((org.relationshipScore / 20) * 10) / 10 : 4.8)).toFixed(1)}
                        </span>
                      </div>
                    </td>
