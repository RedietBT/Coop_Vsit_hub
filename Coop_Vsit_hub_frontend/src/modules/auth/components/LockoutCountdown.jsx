...
export const LockoutCountdown = ({ lockoutUntil, onCountdownEnd }) => {
  ...
  return (
    <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 text-left animate-fadeIn">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div className="flex items-center gap-1.5 mt-3 text-xs font-bold text-rose-800">
